...
- Projeto: `car_area_preservacao_permanente`
...
Cada UF possui perfil proprio em `rules/car_area_preservacao_permanente/<theme_folder>/`.

- `rules/car_area_preservacao_permanente/<theme_folder>/profile.json`
...
- definidos por UF em `rules/car_area_preservacao_permanente/<theme_folder>/input_schema.json`
...
- configuradas por UF em `rules/car_area_preservacao_permanente/<theme_folder>/relations.json`
