...
- `rules/app_car/<theme_folder>/profile.json`
- `rules/app_car/<theme_folder>/input_schema.json`
- `rules/app_car/<theme_folder>/domains.json`
- `rules/app_car/<theme_folder>/relations.json`
- `rules/app_car/<theme_folder>/pipeline.json`
- `rules/app_car/<theme_folder>/style.json`: nao configurado
...
- definidos por UF em `rules/app_car/<theme_folder>/input_schema.json`
...
- configuradas por UF em `rules/app_car/<theme_folder>/relations.json`
...
- Observacao para bases sem download automatico: nao aplicavel; o estado/UF e inferido pelo sufixo do `theme_folder`, por exemplo `app_car_ac` -> `AC`.
