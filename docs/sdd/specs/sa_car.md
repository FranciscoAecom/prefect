...
- `rules/sa_car/<theme_folder>/profile.json`
- `rules/sa_car/<theme_folder>/input_schema.json`
- `rules/sa_car/<theme_folder>/domains.json`
- `rules/sa_car/<theme_folder>/relations.json`
- `rules/sa_car/<theme_folder>/pipeline.json`
- `rules/sa_car/<theme_folder>/style.json`: nao configurado
...
- definidos por UF em `rules/sa_car/<theme_folder>/input_schema.json`
...
- configuradas por UF em `rules/sa_car/<theme_folder>/relations.json`
