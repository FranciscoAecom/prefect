...
Cada UF possui perfil proprio em `rules/car_servidao_administrativa/<theme_folder>/`.

- `rules/car_servidao_administrativa/<theme_folder>/profile.json`
- `rules/car_servidao_administrativa/<theme_folder>/input_schema.json`
- `rules/car_servidao_administrativa/<theme_folder>/domains.json`
- `rules/car_servidao_administrativa/<theme_folder>/relations.json`
- `rules/car_servidao_administrativa/<theme_folder>/pipeline.json`
...
- definidos por UF em `rules/car_servidao_administrativa/<theme_folder>/input_schema.json`
...
| --- | ---: | --- |
| `sdb_cod_tema` | varia por UF | Codigo do tema SA CAR |
| `sdb_nom_tema` | varia por UF | Nome do tema SA CAR |
...
- configuradas por UF em `rules/car_servidao_administrativa/<theme_folder>/relations.json`
...
- `sdb_desc_condic`: `car_servidao_administrativa_transform_desc_condic`
...
- Observacao para bases sem download automatico: nao aplicavel; o estado/UF e inferido pelo sufixo do `theme_folder`, por exemplo `sa_car_ac` -> `AC`.
