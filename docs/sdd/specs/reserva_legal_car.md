...
- `rules/reserva_legal_car/<theme_folder>/profile.json`
- `rules/reserva_legal_car/<theme_folder>/input_schema.json`
- `rules/reserva_legal_car/<theme_folder>/domains.json`
- `rules/reserva_legal_car/<theme_folder>/relations.json`
- `rules/reserva_legal_car/<theme_folder>/pipeline.json`
- `rules/reserva_legal_car/<theme_folder>/style.json`: nao configurado
...
- definidos por UF em `rules/reserva_legal_car/<theme_folder>/input_schema.json`
...
- configuradas por UF em `rules/reserva_legal_car/<theme_folder>/relations.json`
