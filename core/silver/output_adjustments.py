...
def prepare_output_adjustments_gdf(export_gdf, rule_profile):
    output_adjustments = rule_profile.get("output_adjustments", {}) or {}
    if not output_adjustments.get(RELOCATE_OUTSIDE_BRAZIL_BOUNDS_KEY):
        return export_gdf
