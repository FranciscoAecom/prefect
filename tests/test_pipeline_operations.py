...
class PipelineOperationTests(unittest.TestCase):
    def test_infers_operation_kind_from_function_name(self):
        ...
        self.assertEqual(
            infer_operation_kind("car_area_preservacao_permanente_transform_desc_condic"),
            "transform",
        )
    ...
    def test_builds_operations_from_mapping(self):
        operations = build_pipeline_operations(
            ...
            optional_functions={
                "car_area_preservacao_permanente_transform_desc_condic": _noop,
            },
        )
        ...
        self.assertEqual(
            operation.name,
            "car_area_preservacao_permanente_transform_desc_condic",
        )
